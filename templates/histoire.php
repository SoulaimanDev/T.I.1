...
<body>
   ...
   <?php include("inc/menu.php");?>
    ...
    <main class="mainAcc">
        <div class="titttre"><h1>Histoire</h1></div>
        <div class="imgAcc"><img src="img/histoire.png" alt=""></div>
        <p class="expli"> La formation du toponyme viendrait de la racine indo-européenne ath- signifiant probablement « tête » ou « sommet », puisque la forteresse de l’Acropole située au sommet de la colline du même nom, constituerait le « noyau fondateur » de la ville. Ce qui expliquerait d'ailleurs l’origine de la légende mythologique portant sur la naissance d'Athéna selon laquelle la déesse, devenue protectrice de la cité, serait sortie « armée » de la tête de Zeus.
