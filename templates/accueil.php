...
<body>
   ...
   <?php include("inc/menu.php");?>
    ...
    <div class="lienAcc">
    <ul>
        <li><a href="geographie.html">Une briève pésentation de Athènes</a></li>
        <li><a href="histoire.html">Un rappel historique, de sa fondation à aujourd'hui</a></li>
        <li><a href="culture.html">un tour d'horizon en matière d'art et culture</a></li>
        <li><a href="galerie.html">une galerie de photographies</a></li>
        <li><a href="contact.html">un formulaire pour nous contacter</a></li>
        <li><a href="liens.html">des liens vers des sites partenaires</a></li>
       
    </ul>
    </div>
     
    <p class="wiki"><a href="https://fr.wikipedia.org/wiki/Athènes"> source: Wikipedia - ville Athènes</a></p>
